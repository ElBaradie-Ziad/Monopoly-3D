...
template <typename... SupportableEProperties>
class any_executor
{
public:
  /// Default constructor.
  ...
  template <class... OtherSupportableEProperties>
    any_executor(any_executor<OtherSupportableEProperties...> e);
   ...
   * defined when the @c SupportableEProperties... list includes a property of
 ...
 */
template <typename... SupportableEProperties>
bool operator==(const any_executor<SupportableEProperties...>& a,
    const any_executor<SupportableEProperties...>& b) noexcept;
...
public:
  ...
  template <typename... OtherSupportableEProperties>
  any_executor(any_executor<OtherSupportableEProperties...> other)
    : detail::any_executor_base(
...
class any_executor :
  ...
  public detail::any_executor_context<
    any_executor<SupportableEProperties...>,
      typename detail::supportable_properties<
        0, void(SupportableEProperties...)>::find_context_as_property>
{
public:
  any_executor() ASIO_NOEXCEPT
    : detail::any_executor_base(),
      ...
      typename enable_if<
        conditional<
          ...
          detail::is_valid_target_executor<
            Executor, void(SupportableEProperties...)>,
          false_type
        >::type::value
      >::type* = 0)
    : detail::any_executor_base(
  ...
  any_executor(any_executor<OtherSupportableEProperties...> other,
      typename enable_if<
        conditional<
          !is_same<
            any_executor<OtherSupportableEProperties...>,
            any_executor
          >::value,
          typename detail::supportable_properties<
            0, void(SupportableEProperties...)>::template is_valid_target<
              any_executor<OtherSupportableEProperties...> >,
          false_type
        >::type::value
      >::type* = 0)
    : detail::any_executor_base(ASIO_MOVE_CAST(
          any_executor<OtherSupportableEProperties...>)(other), true_type()),
      prop_fns_(prop_fns_table<any_executor<OtherSupportableEProperties...> >())
  {
  }
  ...
  struct find_convertible_property :
      detail::supportable_properties<
        0, void(SupportableEProperties...)>::template
          find_convertible_property<T> {};
    ...
    {
      {
        &detail::any_executor_base::query_fn<
            Ex, SupportableEProperties>,
        &detail::any_executor_base::require_fn<
            any_executor, Ex, SupportableEProperties>,
...
template <typename... SupportableEProperties>
inline void swap(any_executor<SupportableEProperties...>& a,
    any_executor<SupportableEProperties...>& b) ASIO_NOEXCEPT
{
  return a.swap(b);
}
...
template <typename... SupportableEProperties>
struct equality_comparable<execution::any_executor<SupportableEProperties...> >
{
...
template <typename F, typename... SupportableEProperties>
struct execute_member<execution::any_executor<SupportableEProperties...>, F>
{
  static const bool is_valid = true;
...
template <typename Prop, typename... SupportableEProperties>
struct query_member<
    execution::any_executor<SupportableEProperties...>, Prop,
    typename enable_if<
    ...
    >::type>
{
  static const bool is_valid = true;
  static const bool is_noexcept = false;
  typedef execution::any_executor<SupportableEProperties...> result_type;
};

...
template <typename Impl, typename T, typename EProperties,
...
struct can_prefer :
  integral_constant<bool,
    asio_prefer_fn::call_traits<
      prefer_t, T, void(EProperties...)>::overload
...
constexpr bool can_prefer_v
  = can_prefer<T, EProperties ASIO_ELLIPSIS>::value;
...
struct is_nothrow_prefer :
  integral_constant<bool,
    asio_prefer_fn::call_traits<
      prefer_t, T, void(EProperties...)>::is_noexcept>
{
};
...
constexpr bool is_nothrow_prefer_v
  = is_nothrow_prefer<T, EProperties ASIO_ELLIPSIS>::value;
...
struct prefer_result
{
  typedef typename asio_prefer_fn::call_traits<
      prefer_t, T, void(EProperties...)>::result_type type;
};
